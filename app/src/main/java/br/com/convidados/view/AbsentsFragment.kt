...
import br.com.convidados.databinding.FragmentAbsentsBinding
...
class AbsentsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentAbsentsBinding.inflate(inflater, container, false)
        viewModel =
            ViewModelProvider(this).get(AllGuestsViewModel::class.java)

        val recycler = binding.recyclerAbsentsGuests
